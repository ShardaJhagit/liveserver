...
function Show() {
    ...
    function temperature(weather) {
        ...
        return (
            ...
            <div className="font-normal text-xl">{tempmax}|{tempmin}</div>
            ...
            <div>
                ...
                <div className=" h-screen  w-auto p-10  bg-gradient-to-r from-purple-500 to-pink-500 shadow-2xl shadow-slate-600 hover:border-zinc-950 hover: border-solid hover:border-2  " >
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="font-semibold text-xl font-sans"><Clk/></div>
                        <div className="mt-2 font-bold font-serif">{dateBuilder(new Date())}</div>
                        </div>
                        <div >
                        {(typeof weather.main != "undefined") ?
                            <>
                                
                                <div className="shadow-2xl shadow-slate-900 hover:border-zinc-950 hover: border-solid hover:border-2 w-48 mx-auto mt-10 p-4 bg-white">{temperature(weather)}</div></> : " "}</div>
