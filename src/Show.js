                    ...
                    <div className="flex ">
                        ...
                        {(typeof weather.main != "undefined") ?
                            <>
                                ...
                                <div className="shadow-2xl shadow-slate-900 hover:border-zinc-950 hover: border-solid hover:border-2 w-48 mx-auto mt-8 p-4 bg-white">{temperature(weather)}</div></> : " "}</div>
